...
namespace Web_app_practical_1
{
    public partial class User_Profile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                using (SqlDataReader sdr = userdata.ExecuteReader())
                {
                    ...
                    ViewState["Name1"] = sdr["User_Image"].ToString();
                }
        ...
        {
            Boolean phone = validation(userProfile_phoneNumber, userProfile_phonenumber_errormessage);
        ...
        protected void artistProfile_logOutButton_Click(object sender, EventArgs e)
        {
