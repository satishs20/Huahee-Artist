        ...
        <div class="grid">
            ...
            <div class="content">
                ...
                <asp:Label ID="Label7" runat="server" Text="Password :"></asp:Label>&nbsp;
                 <br />
                <asp:HyperLink ID="userProfile_changePasswordHyperlink" runat="server" NavigateUrl="~/chin_sze/Change Password.aspx">Change Password</asp:HyperLink>
                <br />
                <br />


                <asp:Label ID="lblPrice" runat="server" Text="Email :" CssClass="text"></asp:Label>&nbsp;
                 <span class="error"><asp:Literal ID="userProfile_email_errormessage" runat="server"></asp:Literal></span>
                 <br />
                ...
                <asp:Label ID="Label1" runat="server" Text="Phone Number :" CssClass="text"></asp:Label>&nbsp;
                 <span class="error"><asp:Literal ID="userProfile_phonenumber_errormessage" runat="server"></asp:Literal></span>
                 <br />
                ...
                <asp:Button ID="artistProfile_saveButton" runat="server" Text="Save" CssClass="box" OnClick="artistProfile_saveButton_Click" />
                <br />
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/chin_sze/Change Password.aspx">Menu</asp:HyperLink>
            </div>
        </div>
    </>
